...
export type Summary = {
  ...
  verification: { status: string; method: string | null; verifier_version: string; verifier: string; environment_fingerprint: string; verified_at: string };
...
export type Order = {
  ...
  created_at: string; chain_mode?: string; listing?: Listing; on_chain?: Listing["on_chain"]; events?: Ev[]; revealed_in_buyer_console?: boolean; explorer_base?: string | null;
};
